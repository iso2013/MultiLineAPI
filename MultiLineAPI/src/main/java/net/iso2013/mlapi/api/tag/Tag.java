...
public interface Tag {
	 ...
	 */
    ImmutableList<TagController> getTagControllers(boolean sortByLines);
     ...
     */
    void addTagController(TagController controller);
     ...
     */
    void removeTagController(TagController controller);
